    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-white shadow-md p-4">
        ...
        <nav className="space-y-2">
          <Link href="/technician/dashboard" className="flex items-center p-2 text-gray-700 bg-gray-200 rounded-lg">
          ...
          <Link href="/technician/profile" className="flex items-center p-2 text-gray-600 hover:bg-gray-200 rounded-lg">
              ...
              <div key={job._id} className="p-4 border rounded-lg">
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-sm text-gray-600">Customer: {job.customer?.name || 'N/A'}</p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white p-8 rounded-lg shadow-2xl max-w-2xl w-full">
                ...
                <div className="mb-4">
                    ...
                    <p><strong>Phone Number:</strong> {selectedJob.customer?.profile?.phone || 'N/A'}</p>
